...
constructor(props) {
  ...
  createBarPlot = async () => {
    ...
    this.state.x.domain([0, d3.max(this.props.tempData, function(d) { return d.population; })]);
    this.state.y.domain([0, d3.max(this.props.tempData, function(d) { return d.gdp; })]);
   ...
   var circle = this.state.allgroup.selectAll("g")
    ...
    circle.append("circle")
        ...
        .attr("cx", function(d) { return this1.state.x(d.population); })
        .attr("r", 5)
        .attr("cy", function(d) { return this1.state.y(d.gdp); })
